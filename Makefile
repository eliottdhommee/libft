...
NAME = libft.a
SRC = ft_putchar.c ft_putstr.c ft_strlen.c ft_strcmp.c ft_atoi.c ft_strdup.c\
	  ft_strclr.c ft_putendl.c ft_putnbr.c ft_strcpy.c ft_strncpy.c ft_strcat.c\
	  ft_memset.c ft_bzero.c ft_isdigit.c ft_memcpy.c ft_memccpy.c ft_isalpha.c\
	  ft_isalnum.c ft_toupper.c ft_tolower.c ft_memalloc.c ft_memdel.c\
	  ft_strnew.c ft_strdel.c ft_strncmp.c ft_striter.c ft_itoa.c ft_strstr.c\
